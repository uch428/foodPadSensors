...
(cl:defclass <adc1> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass adc1 (<adc1>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <adc1>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'adc1)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package_i-msg:<adc1> is deprecated: use package_i-msg:adc1 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <adc1>))
...
(cl:defmethod adc7-val ((m <adc1>))
  ...
  (adc7 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <adc1>) ostream)
  "Serializes a message object of type '<adc1>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <adc1>) istream)
  "Deserializes a message object of type '<adc1>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<adc1>)))
  "Returns string type for a message object of type '<adc1>"
  "package_i/adc1")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'adc1)))
  "Returns string type for a message object of type 'adc1"
  "package_i/adc1")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<adc1>)))
  "Returns md5sum for a message object of type '<adc1>"
  "be7b48f6f2072307fea1b4cde906d267")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'adc1)))
  "Returns md5sum for a message object of type 'adc1"
  "be7b48f6f2072307fea1b4cde906d267")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<adc1>)))
  "Returns full string definition for message of type '<adc1>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'adc1)))
  "Returns full string definition for message of type 'adc1"
  (cl:format cl:nil "Header header~%uint16 adc0~%uint16 adc1~%uint16 adc2~%uint16 adc3~%uint16 adc4~%uint16 adc5~%uint16 adc6~%uint16 adc7~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <adc1>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <adc1>))
